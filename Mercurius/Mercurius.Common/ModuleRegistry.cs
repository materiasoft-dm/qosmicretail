...
namespace Mercurius.Common
{
    public class ModuleRegistry
    {
        public static IReadOnlyList<string> Modules { get; } = new[]
        {
            ...
            ModuleRegistry.Pages.INVENTORY_LIST,
            ModuleRegistry.Pages.CONFIG_SHOPIFY
        };
        ...
        public static class Pages
        {
            ...
            public const string INVENTORY_LIST = "Shopify Inventory List";
            public const string CONFIG_SHOPIFY = "Configuration - Shopify Integration";
        }
    }
}
